...
<div class="main-main-presentation-div">
    <ul class="nav nav-pills">
        ...
        <li role="presentation"><a href="#">LOOK BOOK</a></li>
        <li role="presentation"><img src="#" style="width: 200px;height: 100px;"/></li>
        <li role="presentation"><a href="#">FEATURES</a></li>
        <li role="presentation"><a href="#">PRICING</a></li>
        <li role="presentation"><a href="#">LOVE STORIES</a></li>
    </ul>
</div>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="http://placehold.it/1500x415" alt="...">
