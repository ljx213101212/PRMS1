...
public interface ScheduleDAO {
    ...
    public abstract AnnualSchedule createValueAnnualSchedule();
    public abstract WeeklySchedule createValueWeeklySchedule();

    /**
     * getListByDate-method. This will create and load list of objects depending
     * on the date of program.
     */
     ...
     * database using given id as identifier. This method is just a convenience
     ...
     */
    public abstract List<ProgramSlot> searchMatching(PSSearchObject valueObject)
            throws SQLException;

  
    public abstract List<AnnualSchedule> retrieveAnnualSchedules()
            throws SQLException;
